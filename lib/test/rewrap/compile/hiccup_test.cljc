    ...
    (let [el (hiccup/compile ["div" ["p" "foo"]])
      ...
      #?@(:cljs [(is (= type "div"))
                 (t/is-el=
                  (.-children props)
                  ["p" #js {:children "foo"}])]
          :clj [(is (= el `(rewrap.core/render "div" nil (rewrap.core/render "p" nil "foo"))))]))))
